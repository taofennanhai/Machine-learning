...
if __name__ == '__main__':
    # 获取cmnli_sup训练集
    file = 'SecondQuestionData/cnsd-mnli/cnsd_multil_train.jsonl'
    out_file1 = 'SecondQuestionData/cmnli_sup_train_data.csv'
    get_sup_train_data(file, out_file1, 'gold_label')

    # 获取ocnli_sup训练集
    file = 'SecondQuestionData/ocnli/train.50k.json'
    out_file1 = 'SecondQuestionData/ocnli_sup_train_data.csv'
    get_sup_train_data(file, out_file1, 'label')

    # 获取ocnli_unsup训练集
    file = 'SecondQuestionData/ocnli/train.50k.json'
    out_file2 = 'SecondQuestionData/ocnli_unsup_train_data.txt'
    get_unsup_train_data_ocnli(file, out_file2)

    # 获取stsb_unsup训练集
    file = 'SecondQuestionData/STS-B/train.txt'
    out_file2 = 'SecondQuestionData/stsb_unsup_train_data.txt'
