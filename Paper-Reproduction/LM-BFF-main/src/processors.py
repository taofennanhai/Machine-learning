"""Dataset utils for different SecondQuestionData settings for GLUE."""
...
class MrpcProcessor(DataProcessor):
    """Processor for the MRPC SecondQuestionData set (GLUE version)."""
...
class MnliProcessor(DataProcessor):
    """Processor for the MultiNLI SecondQuestionData set (GLUE version)."""
...
class MnliMismatchedProcessor(MnliProcessor):
    """Processor for the MultiNLI Mismatched SecondQuestionData set (GLUE version)."""
...
class ColaProcessor(DataProcessor):
    """Processor for the CoLA SecondQuestionData set (GLUE version)."""
...
class Sst2Processor(DataProcessor):
    """Processor for the SST-2 SecondQuestionData set (GLUE version)."""
...
class StsbProcessor(DataProcessor):
    """Processor for the STS-B SecondQuestionData set (GLUE version)."""
...
class QqpProcessor(DataProcessor):
    """Processor for the QQP SecondQuestionData set (GLUE version)."""
...
class QnliProcessor(DataProcessor):
    """Processor for the QNLI SecondQuestionData set (GLUE version)."""
...
class RteProcessor(DataProcessor):
    """Processor for the RTE SecondQuestionData set (GLUE version)."""
...
class WnliProcessor(DataProcessor):
    """Processor for the WNLI SecondQuestionData set (GLUE version)."""
