"""This script samples K examples randomly without replacement from the original SecondQuestionData."""
...
def main():
    ...
    parser.add_argument("--data_dir", type=str, default="SecondQuestionData/original", help="Path to original SecondQuestionData")
    parser.add_argument("--output_dir", type=str, default="SecondQuestionData", help="Output path")
