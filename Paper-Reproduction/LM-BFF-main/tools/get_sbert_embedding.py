...
def main():
    ...
    parser.add_argument("--data_dir", type=str, default="SecondQuestionData/k-shot", help="Path to few-shot SecondQuestionData")
    parser.add_argument("--seed", type=int, nargs="+", default=[42, 13, 21, 87, 100], help="Seeds for SecondQuestionData splits")
