...
def main():
    ...
    parser.add_argument("--data_dir", type=str, default="SecondQuestionData/k-shot", help="Data directory")
    ...
    # Map lower-case names to official names (SecondQuestionData folder name)
    data_dir_mapping = {
        'cola': 'CoLA',
        'mrpc': 'MRPC',
        'qqp': 'QQP',
