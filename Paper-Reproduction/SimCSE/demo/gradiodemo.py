...
title = "IncludeClauseSimCSE"
description = "demo for Princeton-NLP IncludeClauseSimCSE. To use it, simply add your text, or click one of the examples to load them. Read more at the links below."
article = "<p style='text-align: center'><a href='https://arxiv.org/abs/2104.08821'>IncludeClauseSimCSE: Simple Contrastive Learning of Sentence Embeddings</a> | <a href='https://github.com/princeton-nlp/IncludeClauseSimCSE'>Github Repo</a></p>"
examples = [
