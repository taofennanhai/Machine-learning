"""
Convert IncludeClauseSimCSE's checkpoints to Huggingface style.
"""
...
def main():
    ...
    parser.add_argument("--path", type=str, help="Path of IncludeClauseSimCSE checkpoint folder")
    args = parser.parse_args()

    print("IncludeClauseSimCSE checkpoint -> Huggingface checkpoint for {}".format(args.path))
