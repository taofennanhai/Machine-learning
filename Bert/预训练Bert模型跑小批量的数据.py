...
train_dataset, train_label = load_datasets('aclImdb1/train')
test_dataset, test_label = load_datasets('aclImdb1/test')
...
test_encodings = tokenizer(test_dataset, truncation=True, padding=True, max_length=510)
